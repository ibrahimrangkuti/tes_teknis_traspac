...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('templates/css/adminlte.css') }}" />
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      <footer class="app-footer">
        <!--begin::To the end-->
        <div class="float-end d-none d-sm-inline">Aplikasi Kepegawaian</div>
        <!--end::To the end-->
      </footer>
      <!--end::Footer-->
    </div>
    ...
    <script src="{{ asset('templates/js/adminlte.js') }}"></script>
    <!-- OPTIONAL SCRIPTS -->
